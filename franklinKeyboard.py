...
class GUI(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        container = ttk.Frame(self, width=1280, height=800)
...
class StartPage(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        label1 = ttk.Label(self, text="Correct Value", font=font_title)
        label1.pack(side="top", fill="x", pady=7, padx=10)

        self.label1 = ttk.Label(self, text="Enter correct value:", font=font_message)
        self.label1.pack(side="top")
        self.entry1 = ttk.Entry(self)
        self.entry1.pack(side="top")

        self.frame1 = ttk.Frame(self, width=1280, height=800)
        self.frame1.pack(side="top", pady=30)
        self.frame2 = ttk.Frame(self, width=1280, height=800)
